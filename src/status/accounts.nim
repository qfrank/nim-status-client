...
# TODO: this will later be replaced by an event generated by the signal itself
# when the signals move to nim-status
proc confirmLogin*(self: AccountModel): void =
  self.events.emit("loggedIn", Args())
